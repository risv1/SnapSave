                ...
                {sports &&
                  sports.map((sport) => (
                    ...
                    >
                      ...
                      <button onClick={(e: React.MouseEvent<HTMLButtonElement>) => handleRoute(`/admin/${sport.id})`)} className="text-white text-base rounded p-1 w-16 bg-green-500 hover:bg-green-700">
                          Edit
                        </button>
